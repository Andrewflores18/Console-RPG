...
namespace Console_RPG
{
    class Location
    {
        ...
        public static Location Terminal = new Location("Terminal", "An empty Airport seems like a tragady happend here that was a setup to frame the U.S.");

        public static Location FreddyFazbearsPizzaria = new Location("Freddy Fazbear's Pizzaria", "It's a Pizzaria where some kids went missing some say that the Animatronics smell like rotting flesh so they closed this place a day ago anyways i don't mind more pizza for me");
        ...
        public static Location VGDClassroom = new Location("VGD Classroom", "Seem's like the students here are learing on how to make games");
        ...
        public static Location UPSWarehouse = new Location("UPS Warehouse", "Once again it's another warehouse but this time it's for UPS let's hope you can find your package before a UPS Delevery Drive mishandles it");
        ...
        public static Location Antartica = new Location("Antarctica", "Dang it's so cold here maybe we could go somewhere thats not -71°F next time?");
        ...
        public static Location SpidermansHouse = new Location("Spiderman's House (Tom Holland's Spiderman) ", "Why is this Spiderman's house here? what about the OG Spidernam");
